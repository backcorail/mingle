...
<div class="codyboard">	
	<div class="weather">
		...
		<h1>수</h1>
		<a>11.08</a><br>
		<img src="/mingle/img/cody/day_sunny/icon_sunny.png" style="width:50px;height:50px;"/><br>
		<a style="color:#56CCF2">3°</a><a style="color:#D8D8D8">/</a><a style="color:#FF5959">9°</a><br>
		<a></a>
		</div>
	</div>
	<div class="codiTap">
		...
		<h1 class="category_h1">자켓</h1>
	      	<ul class="slide_list">
	        	...
	        	<c:forEach var="n" begin="1" end="5">
					<li class="slide_item">
	        			<img class="item_image" src="/mingle/img/cody/jk.jpg">
	        		</li>
				</c:forEach>
	   ...
	   <h1 class="category_h1">맨투맨</h1>
	      	<ul class="slide_list">
	        	...
	        	<c:forEach var="n" begin="1" end="5">
					<li class="slide_item">
	        			<img class="item_image" src="/mingle/img/cody/mtm.jpg">
	        		</li>
				</c:forEach>
	        	<li class="leftBtn"><img src="/mingle/img/cody/day_sunny/icon_arrow.png" style="width:24px; height:24px;"></li>
	      </ul>
	   ...
	   <h1 class="category_h1">데님팬츠</h1>
	      	<ul class="slide_list">
		        ...
		        <c:forEach var="n" begin="1" end="5">
					<li class="slide_item">
	        			<img class="item_image" src="/mingle/img/cody/dp.jpg">
	        		</li>
				</c:forEach>
	        	<li class="leftBtn"><img src="/mingle/img/cody/day_sunny/icon_arrow.png" style="width:24px; height:24px;"></li>
	      </ul>
	   ...
	   <h1 class="category_h1">스니커즈</h1>
	      	<ul class="slide_list">
	        	...
	        	<c:forEach var="n" begin="1" end="5">
					<li class="slide_item">
	        			<img class="item_image" src="/mingle/img/cody/snk.jpg">
	        		</li>
				</c:forEach>
	        	<li class="leftBtn"><img src="/mingle/img/cody/day_sunny/icon_arrow.png" style="width:24px; height:24px;"></li>
	      </ul>
