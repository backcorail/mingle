...
<form method="post" action="/mingle/style/writeOk" id="frm" class="styleWrite" onsubmit="return validateForm()">
	<div class="styleWrite_wrapper">
		...
		<div class="middle">
	  	...
	  	<a href="#" class="buttonu type--A upload">
		    ...
		    <div class="buttonu__line"></div>
		    <span class="buttonu__text">ENTRY</span>
	  	...
	  	<div class="footer_style">
			...
			<div class="style_title">
				...
				<textarea class="style_title_text"></textarea>
			</div>
	  	</div>
	  	<!-- 작성 취소 버튼 -->
	  	<!-- 작성,취소 버튼 -->
