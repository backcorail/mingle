...
<div class="page">
				...
				<div class="slide">
					<div class="info-box">
						...
						<div class="info">
							...
							<p class="text-info2">10시간전</p>
						</div>
						<div class="follow">
							<button class="follow-btn">팔로우</button>
							<button class="follow-btn2">ㆍㆍㆍ</button>
						</div>
					</div>
					<img src="/mingle/img/style/aaa.jpg" alt="Image 3" />
				</div>
				<div class="slide">
					<div class="info-box">
						<img class="profile-img-info" src="/mingle/img/style/aaa.jpg" />
	...
	<div class="reply-cnt">댓글 0개</div>

	<div class="reply-box">
		<div class="no-reply">첫번째로 댓글을 남겨보세요.</div>
	</div>
</div>
