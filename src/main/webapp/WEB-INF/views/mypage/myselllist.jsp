	...
	<div class="container">
		...
		<div class="div-mypage-main">
			...
			<div class="div-select-date-area">
				<input type="button" value="최근일주일" class="Inika-Regular-18"> <input type="button" value="1개월" class="Inika-Regular-18"> <input type="button" value="3개월" class="Inika-Regular-18">
				<input type="date" class="Inika-Regular-18">
				<div class="Inika-bold-25">~</div>
				<input type="date" class="Inika-Regular-18"> <input type="button" value="조회" class="Inika-Regular-18w">
			</div>
