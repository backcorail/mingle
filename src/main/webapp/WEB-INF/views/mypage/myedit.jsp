			...
			<div class="div-profile-edit-area">
				<div class="div-main-data-area">
					...
					<div class="div-userid-area div-underline-thin-data">
						<input type="text" class="userid Inika-Regular-22 input-userdata-commom" value="q***************@naver."> <input type="button" class="btn-userdata-common" value="변경">
					</div>
					<div class="div-blank"></div>
					<div class="Inika-Regular-16-af">비밀번호</div>
					<div class="div-userid-area div-underline-thin-data">
						<input type="text" class="userpwd Inika-Regular-22 input-userdata-commom" value="a*******************************"> <input type="button" class="btn-userdata-common" value="변경">
					</div>
				</div>
				<div class="div-sub-data-area">
					<div class="Inika-Regular-16-af">닉네임</div>
					<div class="div-niick-area div-underline-thin-data">
						<input type="text" class="usernick Inika-Regular-22 input-userdata-commom" value="adam_12_like_@"> <input type="button" class="btn-userdata-common" value="변경">
					</div>
					<div class="div-blank"></div>
					<div class="Inika-Regular-16-af">이름</div>
					<div class="div-name-area div-underline-thin-data">
						<input type="text" class="userpwd Inika-Regular-22 input-userdata-commom" value="김연아"> <input type="button" class="btn-userdata-common" value="변경">
					</div>
					<div class="div-blank"></div>
					<div class="Inika-Regular-16-af">전화번호</div>
					<div class="div-tel-area div-underline-thin-data">
						<input type="text" class="usertel Inika-Regular-22 input-userdata-commom" value="010-xxxx-xxxx"> <input type="button" class="btn-userdata-common" value="변경">
					</div>
					<div class="div-blank"></div>
					<div class="Inika-Regular-16-af">주소</div>
					<div class="div-addr-area div-underline-thin-data">
						<input type="text" class="useraddr Inika-Regular-22 input-userdata-commom" value="328 Gangnam-daero, Gangnam-gu, Seoul"> <input type="button" class="btn-userdata-common" value="변경">
					</div>
				</div>
			</div>
