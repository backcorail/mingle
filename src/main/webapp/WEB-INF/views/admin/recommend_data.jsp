				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<div class="collapse" id="collapseServer"
							aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="/mingle/admintest/sever_data">Server Data</a>
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">Recommend data</h1>
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item"><a href="/mingle/admintest">Dashboard</a></li>
						<li class="breadcrumb-item active">Recommend Navigation</li>
					</ol>
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i> Recommend List
						</div>
						<div class="card-body">
